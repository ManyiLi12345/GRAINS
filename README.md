...
<span style="color:red">Update: Because of the SUNCG dataset problem, we provide the data format definition and a sample file which can be visualized with this script.</span>
